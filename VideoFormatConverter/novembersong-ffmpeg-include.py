...
# pyinstaller --onefile --console --add-binary "ffmpeg/bin/ffmpeg.exe;ffmpeg/bin" novembersong-ffmpeg-include.py
# ------------------------------------------------------------
...
if getattr(sys, 'frozen', False):
    ffmpeg_exe = os.path.join(sys._MEIPASS, "ffmpeg", "bin", "ffmpeg.exe")
else:
